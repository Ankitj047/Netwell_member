...
class sampleTextField extends Component {
  ...
  SubmitApplictaion = e => {
    if ((this.props.label === 'Zip Code' || this.props.label === 'Zip code of your family residence') && e.detail.flag) {
      ...
      this.props.setChild(e.detail.zipcode, false, this.props.label === 'zip' ? { name: 'postalCode' } : { flag: 'zip', name: 'state' })
    } else {
  ...
  render() {
    ...
    return (
      <CustomTextField
        ...
        InputLabelProps={{ style: { color: this.state.isValid ? '#FA1515' : '#533278' } }}
        //    inputProps={{
