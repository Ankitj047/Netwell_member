...
export default class IDCardFrontViewMob extends Component {
  ...
  render() {
    return (
      <div class="fview">
        <div class="fv_background_image_blue">
          ...
          <div class="fv_top_image_container">
            ...
            this.props.network == 'healthyLife' ? (
              ...
              {this.state.digitalcarddata &&
                this.state.digitalcarddata.memberIdCardList.map((data, index) => (
                  <div>
                    {index == 0 ? (
                      <div>
                        <div class="fv_adult_top_name_blue">
                ...
                {this.state.digitalcarddata &&
                  this.state.digitalcarddata.memberIdCardList.map((data, index) => (
                    <div>
                      {index != 0 ? (
                        <div class="fv_list_view">
                          <div class="fv_list_adultname_blue">
                            {data.firstName} {data.lastName}
                          </div>
            ...
            <div class="fv_right_container">
              ...
              <div class="fv_right_table1">
                ...
                <div class="fv_right_table">
                  ...
                  <div class="fv_table_right_text_groupNo">{this.state.groupno}</div>
              ...
              case 'PHCS':
                return (
                  <div class="fv_center_details_text">
                    ...
                    insurance. We are IN NETWORK for Multiplan/PHCS Practitioner & Ancillary Network.
                    <br />
                    Providers & Members confirmations and questions {this.props.contactNumber}
                  </div>
                )
              case 'healthyLife':
                return (
                  <div class="fv_center_details_text">
                    Universal HealthShare plans from Universal Health Fellowship are health care cost sharing ministry programs, not
                    insurance. We are IN NETWORK for MultiPlan’s PHCS Network for practitioner & ancillary providers.
                    <br /> Providers & Members confirmations and questions &nbsp; {this.props.contactNumber}
                  </div>
                )
