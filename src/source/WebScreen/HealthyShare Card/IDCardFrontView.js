    ...
    return (
      <div className="Rectangle">
        <div id="capture">
          ...
          <div class="web_fview">
            <div class="web_fv_background_image_blue">
                  ...
                  {this.state.digitalcarddata &&
                    this.state.digitalcarddata.memberIdCardList.map((data, index) => (
                      <div>
                        {index == 0 ? (
                          <div>
                            <div class="web_fv_adult_top_name_blue">
                        ...
                        <div>
                          {index != 0 ? (
                            <div class="web_fv_list_view">
                              <div class="web_fv_list_adultname_blue">
                                {data.firstName} {data.lastName}
                              </div>
                ...
                <div class="web_fv_right_container">
                  ...
                  <div class="web_fv_right_table1">
                    ...
                    <div class="web_fv_right_table">
                      ...
                      <div class="web_fv_table_right_text_groupNo">{this.state.groupno}</div>
                  ...
                  case 'healthyLife':
                    return (
                      <div class="web_fv_center_details_text ">
                        ...
                        <br /> Providers & Members confirmations and questions &nbsp; {this.state.contactNumber}
                        {/* (888) 366-6243 */}
                      </div>
                    )
                  case 'smartshare25':
                    return (
                      <div class="web_fv_center_details_text ">
                        ...
                        insurance. We are IN NETWORK for MultiPlan’s PHCS Network for practitioner & ancillary providers.
                        <br />
                        Providers & Members confirmations and questions &nbsp; {this.state.contactNumber}
                        {/* (888) 366-6243 */}
                      </div>
                    )
                  case 'smartshare50':
