...
const headCells = [
  ...
  { id: 'transactionId', numeric: true, disablePadding: false, label: 'Needs ID' },
  { id: 'createdDate', numeric: true, disablePadding: false, label: 'Date' },
  { id: 'type', numeric: false, disablePadding: false, label: 'Needs Amount' },
  { id: 'transactionAmount', numeric: true, disablePadding: false, label: 'Contributed Amount' },
